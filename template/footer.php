	...
	<div class="vertical-space-100"></div>
				<div class="row">
					<div class="col-lg-4 col-md-6 vertical-space-2">
						<h5>About Us</h5>
						<p class="paregraf" style="margin-bottom: 20px"><a href="<?base_url();?>">Lowongan Kerja ID</a> adalah portal lowongan kerja terbaik yang bisa anda temukan di indonesia. Kami akan memberikan pelayanan informasi lowongan kerja terbaik untuk anda, dan ikut serta dalam mengurangi pengangguran di Indonesia.</p>
						<a href="#">
